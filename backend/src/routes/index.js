...
// ============================================================
// TENANT INFO PÚBLICA (para pantalla de login)
// ============================================================
router.get('/tenant-info/:slug', authCtrl.getTenantInfo);

// ============================================================
// SUPER ADMIN (rutas sin tenant)
// ============================================================
...
// Middleware chain: resolveTenant → authenticate → checkTenantAccess
// ============================================================
const tenantRouter = require('express').Router({ mergeParams: true });

// Auth del tenant (solo resolveTenant, sin authenticate)
...
// Montar tenant router con middleware de resolución
